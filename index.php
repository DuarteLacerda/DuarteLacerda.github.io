...
<body id="body">
		...
		<div class="container">
			<div class="row">
				<div class="sec-title text-center mb50 wow bounceInDown animated" data-wow-duration="500ms">
					<h2>About me</h2>
					<div class="devider"><i class="fa fa-rebel" aria-hidden="true"></i></div>
				</div>
				...
				<div class="col-md-4 wow fadeInLeft" data-wow-duration="500ms">
					<div class="service-item">
						...
						<div class="service-desc">
							<h3>Hello...</h3>
							<p>My name is Duarte Lacerda and I'm 17 years old.
								I'm from Leiria, Portugal and I like rock climbing, playing video games, playing with my
								arduino, doing robots and programming/coding.
							</p>
						</div>
					</div>
				</div>
				<div class="col-md-4 wow fadeInLeft" data-wow-duration="500ms">
					<div class="service-item">
						...
						<div class="service-desc">
							<h3>Internships...</h3>
							<p>My first internships was in TEKEVER from 03/05/2020 to 05/07/2021.
								<br>
								It was a great experience, developed a lot of skills, like teamwork
								and my responsibility increased.
							</p>
						</div>
					</div>
				</div>
				<div class="col-md-4 wow fadeInLeft" data-wow-duration="500ms">
					<div class="service-item">
						...
						<div class="service-desc">
							<h3>Lectures...</h3>
							<p>Since my school age, I've had some talks about technology, such as Web Summit, Aduino
								Day, App in a
								Day, Moche XL Games World and Code Week, which I really enjoyed.
							</p>
						</div>
					</div>
				</div>
	...
	<section id="events" class="events clearfix">
		<div class="container">
			<div class="row">
				...
				<div class="sec-sub-title text-center">
					<p>The coolest events I've been to</p>
				</div>
			</div>
		</div>
			...
			<div class="row mb50">
				...
				<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 wow fadeInLeft animated" data-wow-duration="500ms">
					<div class="contact-address">
						<h3>Contact</h3>
						<p>Email: duartelacerda4@gmail.com</p>
						<p>Caldas da Rainha, Leiria, Portugal</p>
						<p>Phone: +351 96969696</p>
					</div>
				</div>
				<!-- end contact address -->
			...
			<div class="row">
				<div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp animated" data-wow-duration="500ms">
					<div class="footer-single">
						...
						<p> <br> Amor é fogo que arde sem se ver, <br>
				...
				<div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="600ms">
					<div class="footer-single">
						<h6>Follow me</h6>
						<ul>
							<li><a href="https://www.facebook.com/Duarte.lacerda.PT">Facebook</a></li>
							<li><a href="https://twitter.com/duartelacerda1">Twitter</a></li>
							<li><a href="https://www.instagram.com/duarte_lacerda/">Instagram</a></li>
							<li><a href="https://github.com/duartelacerda">GitHub</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<p class="copyright text-center">
						Copyright © 2021 <a href="https://www.instagram.com/duarte_lacerda/">Duarte Lacerda</a>. All
						rights reserved.
						Designed & developed by <a href="https://www.instagram.com/duarte_lacerda/">Duarte Lacerda</a>
					</p>
				</div>
			</div>
		</div>
